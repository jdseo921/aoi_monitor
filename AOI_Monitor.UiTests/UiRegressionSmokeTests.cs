...
public sealed class UiRegressionSmokeTests : IDisposable
{
    ...
    private static IReadOnlyList<UiPageDefinition> CreatePageDefinitions()
    {
        ...
        return new[]
        {
            ...
            new UiPageDefinition("library", "Board & Images", () => new LibraryView(), false, new[] { "RecordsGrid", "ImportStatusText" }),
            ...
            new UiPageDefinition("spc", "Yield Analytics", () => new SpcView(), false, new[] { "VerdictBreakdownText", "YieldText", "DbHealthGrid", "DatabaseWarningText" }),
            new UiPageDefinition("reports", "Export & Trace", () => new ReportsView(), true, new[] { "CancelWorkButton", "InspectionGrid", "ExportGrid", "AuditGrid", "MesSpoolGrid", "CentralSyncGrid" }),
            new UiPageDefinition("readiness", "Readiness & QA", () => new ReadinessQaView(), true, new[] { "CancelWorkButton", "PilotIssuesGrid", "FactoryReadinessGrid", "Stage1ReadinessGrid", "ManagementDefectGrid", "FactoryAcceptanceGrid" }),
            ...
            new UiPageDefinition("pilot", "Hardware Readiness", () => new PilotWizardView(), false, new[] { "ProfileCombo", "StepsGrid", "StatusText", "StepsEmptyStateText" }),
            new UiPageDefinition("factory-readiness", "Factory Readiness", () => new ReadinessQaView(), true, new[] { "FactoryReadinessGrid" }),
            new UiPageDefinition("management-dashboard", "Management Dashboard", () => new ReadinessQaView(), true, new[] { "ManagementDefectGrid", "ManagementRoiGrid", "ManagementModelTrendGrid" }),
