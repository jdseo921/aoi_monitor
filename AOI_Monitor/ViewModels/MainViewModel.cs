...
public class MainViewModel : ViewModelBase
{
    ...
    public ObservableCollection<NavPage> NavPages { get; } = new()
    {
        ...
        new NavPage { Key="readiness",   Number="13", Group="analyze", Title="Readiness & QA",     Subtitle="stage gates, checklists, acceptance" },
    ...
    public void RefreshLanguage(UiLanguage language)
    {
        foreach (var page in NavPages)
        {
            (page.Title, page.Subtitle) = page.Key switch
            {
                ...
                "readiness" => T(language, "Readiness & QA", "stage gates, checklists, acceptance", "\uC900\uBE44\uB3C4 / \uD488\uC9C8", "\uB2E8\uACC4 \uAC8C\uC774\uD2B8/\uCCB4\uD06C\uB9AC\uC2A4\uD2B8/\uC2B9\uC778"),
