...
public static class UiPreferencesService
{
    ...
    private static readonly Dictionary<string, string> KoreanText = new(StringComparer.Ordinal)
    {
        ...
        [" / Operator "] = " / 작업자 ",
        [" / Possible escapes "] = " / 유출 가능 ",
        ["0 features"] = "특징 0개",
        ["2D Calibration Profile / Stage 2 Preparation"] = "2D 보정 프로파일 / 2단계 준비",
        ["30-minute local stability"] = "30분 로컬 안정성",
        ["3D Surface Height Map"] = "3D 표면 높이 맵",
        ["4-hour client demo readiness"] = "4시간 고객 데모 준비도",
        ["5-minute smoke"] = "5분 스모크",
        ["8-hour factory PoC"] = "8시간 공장 PoC",
        ["AI / Models > AI Training Setup"] = "AI / 모델 > AI 학습 설정",
        ["API Key"] = "API 키",
        ["Abandoned"] = "폐기됨",
        ["Accept Defect"] = "결함 확정",
        ["Acceptance"] = "승인",
        ["Access"] = "접근",
        ["Acquisition"] = "영상 획득",
        ["Active profile: none"] = "활성 프로파일: 없음",
        ["Active taxonomy not loaded."] = "활성 분류 체계가 로드되지 않았습니다.",
        ["Adapter Folder"] = "어댑터 폴더",
        ["Add Calibration Point"] = "보정 지점 추가",
        ["Add Images"] = "이미지 추가",
        ["Add Point"] = "지점 추가",
        ["Add User"] = "사용자 추가",
        ["Admin"] = "관리자",
        ["Alarms"] = "알람",
        ["Alignment / Difference Control"] = "정렬 / 차이 제어",
        ["Annotated Overlays"] = "주석 오버레이",
        ["Anomaly Heatmap Preview"] = "이상 히트맵 미리보기",
        ["Anomaly Threshold Map"] = "이상 임계값 맵",
        ["Apply Data Retention Policy"] = "데이터 보존 정책 적용",
        ["Apply Filters"] = "필터 적용",
        ["Approve"] = "승인",
        ["Archive Project"] = "프로젝트 보관",
        ["Archive-then-purge: logs older than the configured retention window are copied to the recoverable LogArchive and removed from the live tables at startup."] = "보관 후 삭제: 구성된 보존 기간보다 오래된 로그는 시작 시 복구 가능한 LogArchive로 복사된 후 활성 테이블에서 제거됩니다.",
        ["Audit Action Type"] = "감사 작업 유형",
        ["Audit Trail CSV"] = "감사 추적 CSV",
        ["Auth"] = "인증",
        ["Auth Mode"] = "인증 모드",
        ["Auto-Archive Policy"] = "자동 보관 정책",
        ["Automatic upload when inspection result is saved"] = "검사 결과 저장 시 자동 업로드",
        ["Baseline"] = "베이스라인",
        ["Basic Auth"] = "Basic 인증",
        ["Batch Import"] = "일괄 가져오기",
        ["Batch Relabel"] = "일괄 재라벨링",
        ["Batch Run"] = "일괄 실행",
        ["Bearer Token"] = "Bearer 토큰",
        ["Benchmark"] = "벤치마크",
        ["Blockers"] = "차단 항목",
        ["Board Model"] = "보드 모델",
        ["Bottom Device ID"] = "하면 장치 ID",
        ["Broken Vault Links"] = "손상된 보관소 링크",
        ["Build/test evidence: --"] = "빌드/테스트 증빙: --",
        ["Calibrate False Calls"] = "허위 검출 보정",
        ["Calibration Points"] = "보정 지점",
        ["Calibration Profile"] = "보정 프로파일",
        ["Calibration Runs"] = "보정 실행 이력",
        ["Camera Source"] = "카메라 소스",
        ["Cancel Acceptance"] = "승인 취소",
        ["Captured"] = "촬영",
        ["Category"] = "카테고리",
        ["Central Evidence Sync"] = "중앙 증빙 동기화",
        ["Central Sync (Optional Management Aggregation)"] = "중앙 동기화 (선택적 관리 집계)",
        ["Central Sync copies selected evidence to a configured folder or service. Local SQLite remains the offline source of truth."] = "중앙 동기화는 선택한 증빙을 구성된 폴더 또는 서비스로 복사합니다. 로컬 SQLite가 오프라인 기준 원본으로 유지됩니다.",
        ["Central sync disabled. Local SQLite remains the offline source of truth."] = "중앙 동기화 비활성. 로컬 SQLite가 오프라인 기준 원본으로 유지됩니다.",
        ["Changes are staged until Apply. Cancel discards edits and restores the last saved asset settings."] = "변경 사항은 적용을 누를 때까지 대기 상태로 유지됩니다. 취소는 편집 내용을 버리고 마지막으로 저장된 자산 설정을 복원합니다.",
        ["Checked at"] = "확인 시각",
        ["Clear"] = "지우기",
        ["Client Demo Readiness"] = "고객 데모 준비도",
        ["Client demo readiness: not evaluated"] = "고객 데모 준비도: 미평가",
        ["Close"] = "닫기",
        ["Close Selected"] = "선택 항목 닫기",
        ["Command"] = "명령",
        ["Commissioning Mode"] = "시운전 모드",
        ["Compare Golden"] = "기준 비교",
        ["Comparison Findings"] = "비교 결과",
        ["Confidence"] = "신뢰도",
        ["Continuous"] = "연속",
        ["Coordinate mapping shown in Main Inspection is approximate board-mm evidence for planning only. Stage 2 camera calibration and Stage 3 robot coordinate validation are still required."] = "메인 검사에 표시되는 좌표 매핑은 계획용 근사 보드 mm 증빙입니다. 2단계 카메라 보정과 3단계 로봇 좌표 검증이 여전히 필요합니다.",
        ["Create Model Release Package"] = "모델 릴리스 패키지 생성",
        ["Create Stage 1 Customer Package"] = "1단계 고객 패키지 생성",
        ["Create Training Project"] = "학습 프로젝트 생성",
        ["Current Runtime"] = "현재 런타임",
        ["Current Step"] = "현재 단계",
        ["Customer Pilot Evidence Steps"] = "고객 파일럿 증빙 단계",
        ["DB Integrity"] = "DB 무결성",
        ["DB REV "] = "DB 리비전 ",
        ["DB Updated "] = "DB 갱신 ",
        ["Dashboard not loaded."] = "대시보드가 로드되지 않았습니다.",
        ["Data Retention"] = "데이터 보존",
        ["Database Filter Console"] = "데이터베이스 필터 콘솔",
        ["Database Health"] = "데이터베이스 건강",
        ["Database Transparency (reference)"] = "데이터베이스 투명성 (참고)",
        ["Database and Image Index"] = "데이터베이스 및 이미지 인덱스",
        ["Default Module"] = "기본 모듈",
        ["Default Policy"] = "기본 정책",
        ["Default mode is Not Connected. Mock local writes JSON evidence only."] = "기본 모드는 연결 안 됨입니다. 모의 로컬은 JSON 증빙만 기록합니다.",
        ["Defect Overlay"] = "결함 오버레이",
        ["Defect Sample"] = "결함 샘플",
        ["Defect Taxonomy"] = "결함 분류 체계",
        ["Defect Type"] = "결함 유형",
        ["Define image-to-board point pairs for planning camera/robot coordinate mapping."] = "카메라/로봇 좌표 매핑 계획을 위한 이미지-보드 지점 쌍을 정의합니다.",
        ["Delete"] = "삭제",
        ["Delete Generated Artifacts"] = "생성된 산출물 삭제",
        ["Demo"] = "데모",
        ["Demo Board"] = "데모 보드",
        ["Demo Mode allows sample data, demo role selection, and simulated sources."] = "데모 모드에서는 샘플 데이터, 데모 역할 선택, 시뮬레이션 소스를 사용할 수 있습니다.",
        ["Demo OK"] = "데모 OK",
        ["Demo Trend / Not Live Data"] = "데모 추세 / 실시간 데이터 아님",
        ["Deploy"] = "배포",
        ["Deploy with Waiver"] = "면제(웨이버) 배포",
        ["Deployment Profile"] = "배포 프로파일",
        ["Deployment Target"] = "배포 대상",
        ["Detected Features"] = "검출된 특징",
        ["Detection Priority"] = "검출 우선순위",
        ["Difference Score"] = "차이 점수",
        ["Disable"] = "비활성화",
        ["Disabled"] = "비활성",
        ["Discover Adapters"] = "어댑터 검색",
        ["Discover Cameras"] = "카메라 검색",
        ["Dismiss"] = "닫기",
        ["Documentation Boundary"] = "문서 경계",
        ["Drag: rotate   -   Wheel: zoom   -   Right-drag: pan"] = "드래그: 회전   -   휠: 확대/축소   -   우클릭 드래그: 이동",
        ["Duplicate Project"] = "프로젝트 복제",
        ["Enable automatic archive and purge"] = "자동 보관 및 삭제 사용",
        ["Endpoint/Folder"] = "엔드포인트/폴더",
        ["Engineer"] = "엔지니어",
        ["Engineer/Admin only. Label aliases, customer display names, model label IDs, and MES defect codes are audited through the active taxonomy."] = "엔지니어/관리자 전용입니다. 라벨 별칭, 고객 표시 이름, 모델 라벨 ID, MES 결함 코드는 활성 분류 체계를 통해 감사됩니다.",
        ["Escapes"] = "유출",
        ["Evidence Exports"] = "증빙 내보내기",
        ["Evidence Exports / Maintenance"] = "증빙 내보내기 / 유지 관리",
        ["Evidence Required"] = "필요 증빙",
        ["Evidence boundary"] = "증빙 경계",
        ["Evidence list not loaded."] = "증빙 목록이 로드되지 않았습니다.",
        ["Exercise heavy page loads"] = "무거운 페이지 로드 수행",
        ["Export 3D Report"] = "3D 보고서 내보내기",
        ["Export Artifacts"] = "산출물 내보내기",
        ["Export Bundle"] = "번들 내보내기",
        ["Export Central Sync Report"] = "중앙 동기화 보고서 내보내기",
        ["Export Client Learning Report"] = "고객 학습 보고서 내보내기",
        ["Export Dashboard HTML/CSV/PDF"] = "대시보드 HTML/CSV/PDF 내보내기",
        ["Export Demo Gate"] = "데모 게이트 내보내기",
        ["Export FAT Package"] = "FAT 패키지 내보내기",
        ["Export HTML/PDF/JSON"] = "HTML/PDF/JSON 내보내기",
        ["Export Hardware Acceptance Package"] = "하드웨어 승인 패키지 내보내기",
        ["Export Issue Report"] = "이슈 보고서 내보내기",
        ["Export Latest Soak Evidence"] = "최신 소크 테스트 증빙 내보내기",
        ["Export Learning Report"] = "학습 보고서 내보내기",
        ["Export MES Contract"] = "MES 연동 계약 내보내기",
        ["Export Pair"] = "비교 쌍 내보내기",
        ["Export Queue Report"] = "대기열 보고서 내보내기",
        ["Export Readiness Evidence"] = "준비도 증빙 내보내기",
        ["Export Selected"] = "선택 항목 내보내기",
        ["Export Stage 1 Readiness Report"] = "1단계 준비도 보고서 내보내기",
        ["Export Visual Evidence"] = "시각 증빙 내보내기",
        ["Export status"] = "내보내기 상태",
        ["Exported Reports"] = "내보낸 보고서",
        ["Exposure / Gain"] = "노출 / 게인",
        ["Failed"] = "실패",
        ["False Calls"] = "허위 검출",
        ["False calls "] = "허위 검출 ",
        ["False-Call Behavior"] = "허위 검출 동작",
        ["File Drop"] = "파일 드롭",
        ["Filter production evidence, operator decisions, exports, and queue activity. Long paths are available through hover tooltips."] = "운영 증빙, 작업자 결정, 내보내기, 대기열 활동을 필터링합니다. 긴 경로는 마우스 오버 툴팁으로 확인할 수 있습니다.",
        ["Filters"] = "필터",
        ["Folder Simulation"] = "폴더 시뮬레이션",
        ["Formal acceptance requires customer/evaluator dataset"] = "공식 승인에는 고객/평가자 데이터셋 필요",
        ["From"] = "시작일",
        ["Full Factory Automation"] = "전체 공장 자동화",
        ["GT Overlay"] = "GT 오버레이",
        ["GUI Role"] = "GUI 역할",
        ["Generate Checklist"] = "체크리스트 생성",
        ["Generic Vision Adapter (Real Hardware)"] = "일반 비전 어댑터 (실제 하드웨어)",
        ["Generic adapter configured is not the same as camera connected."] = "일반 어댑터를 구성했다고 해서 카메라가 연결된 것은 아닙니다.",
        ["Golden Reference"] = "기준 이미지",
        ["Good Board Marked Defect"] = "양품 결함 판정",
        ["Hardware Trigger"] = "하드웨어 트리거",
        ["Hardware acceptance collects evidence. Simulated or not connected states remain clearly labeled and are not production camera validation."] = "하드웨어 승인은 증빙을 수집합니다. 시뮬레이션 또는 연결 안 됨 상태는 명확하게 표시되며 운영 카메라 검증이 아닙니다.",
        ["Hardware/MES planned"] = "하드웨어/MES 계획됨",
        ["Height Min / Max"] = "높이 최소 / 최대",
        ["Height Scale"] = "높이 스케일",
        ["Height Slice Profile"] = "높이 단면 프로파일",
        ["High"] = "높음",
        ["IDLE"] = "대기",
        ["IMG_GOLD_0241 / verified OK"] = "IMG_GOLD_0241 / 검증됨 OK",
        ["Image + ROI + GT + Inspection Result"] = "이미지 + ROI + GT + 검사 결과",
        ["Image Groups"] = "이미지 그룹",
        ["Image Link State"] = "이미지 연결 상태",
        ["Image-only Stage 1 learning"] = "이미지 전용 1단계 학습",
        ["Image-only Stage 1 models learned from Golden / OK image groups. Setting active here does not claim live camera validation or production acceptance."] = "기준 / OK 이미지 그룹에서 학습된 이미지 전용 1단계 모델입니다. 여기서 활성으로 설정해도 실시간 카메라 검증이나 운영 승인을 의미하지 않습니다.",
        ["Import Build/Test Evidence"] = "빌드/테스트 증빙 가져오기",
        ["Import CSV"] = "CSV 가져오기",
        ["Import Convention Folder"] = "규약 폴더 가져오기",
        ["Import Folder"] = "폴더 가져오기",
        ["Imported images are loaded from the local SQLite image table."] = "가져온 이미지는 로컬 SQLite 이미지 테이블에서 불러옵니다.",
        ["Include image file references only when explicitly enabled"] = "명시적으로 활성화한 경우에만 이미지 파일 참조 포함",
        ["Input Size"] = "입력 크기",
        ["Input Tensor"] = "입력 텐서",
        ["Inspect Samples"] = "샘플 검사",
        ["Inspection Engine Configuration"] = "검사 엔진 구성",
        ["Inspection History CSV"] = "검사 이력 CSV",
        ["Inspection Records"] = "검사 기록",
        ["Installation Notes"] = "설치 노트",
        ["Label Map Path"] = "라벨 맵 경로",
        ["Language/font changes are applied after pressing Apply. Supported shell, page, table, and Settings labels update immediately; technical codes and evidence IDs remain English for traceability."] = "언어/글꼴 변경은 적용을 누른 후 반영됩니다. 지원되는 셸, 페이지, 테이블, 설정 라벨은 즉시 갱신되며, 기술 코드와 증빙 ID는 추적성을 위해 영문으로 유지됩니다.",
        ["Last model check"] = "마지막 모델 점검",
        ["Latest customer package: --"] = "최신 고객 패키지: --",
        ["Latest soak-test report: --"] = "최신 소크 테스트 보고서: --",
        ["Learn Normal PCB Appearance"] = "정상 PCB 외관 학습",
        ["Learned PCB Visual Model"] = "학습된 PCB 시각 모델",
        ["Learned PCB Visual Model evidence unavailable."] = "학습된 PCB 시각 모델 증빙을 사용할 수 없습니다.",
        ["Learned PCB Visual Models"] = "학습된 PCB 시각 모델",
        ["Learned Reference Image"] = "학습된 기준 이미지",
        ["Learned Tolerance Map"] = "학습된 공차 맵",
        ["Learned Visual Model Versions"] = "학습된 시각 모델 버전",
        ["Learning Projects"] = "학습 프로젝트",
        ["Light"] = "조명",
        ["Lighting Sync (Stage 2 Boundary)"] = "조명 동기화 (2단계 경계)",
        ["Lighting can be simulated, TCP, or serial. Real hardware commands are sent only when explicitly configured."] = "조명은 시뮬레이션, TCP 또는 시리얼로 설정할 수 있습니다. 실제 하드웨어 명령은 명시적으로 구성된 경우에만 전송됩니다.",
        ["Lighting status"] = "조명 상태",
        ["Link "] = "링크 ",
        ["List checks"] = "목록 점검 횟수",
        ["List quality"] = "목록 품질",
        ["Load Height CSV"] = "높이 CSV 불러오기",
        ["Load a CSV with columns: x,y,height"] = "x,y,height 열이 포함된 CSV를 불러오십시오.",
        ["Load a sample calibration image. Optional: click the preview to fill Image X/Y fields."] = "샘플 보정 이미지를 불러오십시오. 선택 사항: 미리보기를 클릭하면 이미지 X/Y 필드가 채워집니다.",
        ["Loading..."] = "불러오는 중...",
        ["Local DB / No MES Writeback"] = "로컬 DB / MES 미전송",
        ["Local Model Registry"] = "로컬 모델 레지스트리",
        ["Local WPF App"] = "로컬 WPF 앱",
        ["Log Filters"] = "로그 필터",
        ["Login"] = "로그인",
        ["Logs older than the retention window are copied into the recoverable archive and then removed from the live tables. The archive keeps the full record. Purge is applied at application startup."] = "보존 기간이 지난 로그는 복구 가능한 보관소로 복사된 뒤 실사용 테이블에서 제거됩니다. 보관소에는 전체 기록이 유지됩니다. 삭제는 애플리케이션 시작 시 적용됩니다.",
        ["MES / ERP Integration Boundary"] = "MES / ERP 통합 경계",
        ["MES Mode"] = "MES 모드",
        ["MES Traceability Queue"] = "MES 추적성 대기열",
        ["MES is the factory system used for traceability, result upload, and production records. Mock REST is clearly labeled and is not production MES."] = "MES는 추적성, 결과 업로드, 생산 기록에 사용되는 공장 시스템입니다. 모의 REST는 명확하게 표시되며 운영 MES가 아닙니다.",
        ["MES status"] = "MES 상태",
        ["MES: Not Connected"] = "MES: 연결 안 됨",
        ["Manage Trained Data"] = "학습 데이터 관리",
        ["Mandatory Review Sequence"] = "필수 검토 순서",
        ["Mark MES Abandoned"] = "MES 폐기 표시",
        ["Maximize Defect Recall"] = "결함 재현율 최대화",
        ["Medium"] = "중간",
        ["Minimize False Positives"] = "허위 검출 최소화",
        ["Missing Evidence"] = "누락된 증빙",
        ["Mock Endpoint"] = "모의 엔드포인트",
        ["Mock Local / REST"] = "모의 로컬 / REST",
        ["Mode"] = "모드",
        ["Model / Board"] = "모델 / 보드",
        ["Model Path"] = "모델 경로",
        ["Model acceptance idle."] = "모델 승인 대기 중.",
        ["NOT RUN"] = "미실행",
        ["Next Action"] = "다음 조치",
        ["Next Recommended Action"] = "다음 권장 조치",
        ["No Camera / Not Connected"] = "카메라 없음 / 연결 안 됨",
        ["No calibration points yet - click the image to add the first point."] = "보정 지점이 아직 없습니다 - 이미지를 클릭하여 첫 지점을 추가하십시오.",
        ["No learned visual model selected."] = "선택된 학습 시각 모델이 없습니다.",
        ["No model configuration test has been run."] = "모델 설정 테스트가 실행되지 않았습니다.",
        ["No per-defect variables or training bounding boxes are required for this workflow."] = "이 워크플로에는 결함별 변수나 학습 바운딩 박스가 필요하지 않습니다.",
        ["No pilot session - press Start New Pilot to begin."] = "파일럿 세션 없음 - 새 파일럿 시작을 눌러 시작하십시오.",
        ["No readiness evidence loaded"] = "준비도 증빙 없음",
        ["No records loaded"] = "기록 없음",
        ["No saved profile loaded."] = "저장된 프로파일이 없습니다.",
        ["None"] = "없음",
        ["None / Not Connected"] = "없음 / 연결 안 됨",
        ["Not Tested"] = "테스트 안 됨",
        ["Not configured"] = "구성 안 됨",
        ["Not live camera validation"] = "실시간 카메라 검증 아님",
        ["Not validated"] = "미검증",
        ["ONNX ML Model"] = "ONNX ML 모델",
        ["ONNX is the production ML path. Pixel Difference is a prototype fallback. Learned PCB Visual Model is image-only Stage 1 learning and is not live camera validation."] = "ONNX는 운영 ML 경로입니다. 픽셀 차이는 프로토타입 대체 경로입니다. 학습된 PCB 시각 모델은 이미지 전용 1단계 학습이며 실시간 카메라 검증이 아닙니다.",
        ["Open Artifact Folder"] = "산출물 폴더 열기",
        ["Open Build Evidence Folder"] = "빌드 증빙 폴더 열기",
        ["Open Folder"] = "폴더 열기",
        ["Open Guide"] = "가이드 열기",
        ["Open Latest Benchmark Report"] = "최신 벤치마크 보고서 열기",
        ["Open Latest Validation Package"] = "최신 검증 패키지 열기",
        ["Open Project"] = "프로젝트 열기",
        ["Open Record"] = "기록 열기",
        ["Open Sample Dataset Guide"] = "샘플 데이터셋 가이드 열기",
        ["Open Settings"] = "설정 열기",
        ["Operating Mode"] = "운전 모드",
        ["Output Tensor"] = "출력 텐서",
        ["Pending"] = "대기 중",
        ["Performance Benchmark"] = "성능 벤치마크",
        ["Pilot"] = "파일럿",
        ["Pilot Hardware Adapter"] = "파일럿 하드웨어 어댑터",
        ["Pilot issues not loaded."] = "파일럿 이슈가 로드되지 않았습니다.",
        ["Planned filters. Filtering is not configured in the Stage 1 prototype; the table lists records unfiltered."] = "계획된 필터입니다. 1단계 프로토타입에서는 필터링이 구성되어 있지 않으며, 테이블은 기록을 필터링 없이 표시합니다.",
        ["Preflight"] = "사전 점검",
        ["Prepare"] = "준비",
        ["Prepares local candidate files only. No model training, fine-tuning, or deployment is run from this prototype."] = "로컬 후보 파일만 준비합니다. 이 프로토타입에서는 모델 학습, 미세 조정 또는 배포가 실행되지 않습니다.",
        ["Preview"] = "미리보기",
        ["Primary Evidence"] = "주요 증빙",
        ["Production"] = "운영",
        ["Production Database Boundary"] = "운영 데이터베이스 경계",
        ["Production REST"] = "운영 REST",
        ["Profile"] = "프로파일",
        ["Profile Name"] = "프로파일 이름",
        ["Program"] = "프로그램",
        ["Programs"] = "프로그램",
        ["Progress Timeline"] = "진행 타임라인",
        ["Project Name"] = "프로젝트 이름",
        ["Promote to Production Candidate"] = "운영 후보로 승격",
        ["Prototype Filters"] = "프로토타입 필터",
        ["Prototype Runtime Notes"] = "프로토타입 런타임 노트",
        ["Prototype note: this app runs local file-based review only; service deployment and hardware integration are planned."] = "프로토타입 참고: 이 앱은 로컬 파일 기반 검토만 실행하며, 서비스 배포와 하드웨어 통합은 아직 계획 단계입니다.",
        ["Queue Central Sync"] = "중앙 동기화 대기열 등록",
        ["Queued samples"] = "대기열 샘플",
        ["REC "] = "레코드 ",
        ["REST API Boundary"] = "REST API 경계",
        ["REST Base URL"] = "REST 기본 URL",
        ["REST Paths"] = "REST 경로",
        ["REST mode is an integration boundary, not MES validation. OPC UA is a Stage 4 adapter TODO. Secrets are redacted from logs/status."] = "REST 모드는 통합 경계이며 MES 검증이 아닙니다. OPC UA는 4단계 어댑터 TODO입니다. 시크릿은 로그/상태에서 숨김 처리됩니다.",
        ["ROI mismatch vs golden"] = "기준 대비 ROI 불일치",
        ["Readiness and Quality Gates"] = "준비도 및 품질 게이트",
        ["Ready."] = "준비됨.",
        ["Rebuild Image Index"] = "이미지 인덱스 재구축",
        ["Rebuild Learned Model"] = "학습 모델 재구축",
        ["Recipe Version"] = "레시피 버전",
        ["Recoverable page error"] = "복구 가능한 페이지 오류",
        ["Redact endpoints/folders from exported reports"] = "내보낸 보고서에서 엔드포인트/폴더 숨김",
        ["Redact image and package paths from payloads"] = "페이로드에서 이미지 및 패키지 경로 숨김",
        ["Redact operator identifiers from payloads"] = "페이로드에서 작업자 식별자 숨김",
        ["Refresh Checklist"] = "체크리스트 새로고침",
        ["Refresh Dashboard"] = "대시보드 새로고침",
        ["Refresh Evidence List"] = "증빙 목록 새로고침",
        ["Refresh Issues"] = "이슈 새로고침",
        ["Refresh Stage 1 Readiness"] = "1단계 준비도 새로고침",
        ["Register Model"] = "모델 등록",
        ["Reject Defect"] = "결함 기각",
        ["Reload Profiles"] = "프로파일 다시 불러오기",
        ["Remove Selected"] = "선택 항목 제거",
        ["Rename Project"] = "프로젝트 이름 변경",
        ["Reset View"] = "보기 재설정",
        ["Resolution and language choices are staged until Apply."] = "해상도와 언어 선택은 적용을 누를 때까지 반영되지 않습니다.",
        ["Resume Latest"] = "최근 파일럿 재개",
        ["Retention days"] = "보존 일수",
        ["Retention policy: loading..."] = "보존 정책: 불러오는 중...",
        ["Retire"] = "폐기",
        ["Retry"] = "재시도",
        ["Retry / Secret"] = "재시도 / 시크릿",
        ["Retry All Central"] = "중앙 전체 재시도",
        ["Retry All Waiting Uploads"] = "대기 중인 업로드 전체 재시도",
        ["Retry Selected Central"] = "선택 항목 중앙 재시도",
        ["Retry Selected Upload"] = "선택 항목 업로드 재시도",
        ["Review Console"] = "검토 콘솔",
        ["Review Default"] = "검토 기본값",
        ["Review Log CSV"] = "검토 로그 CSV",
        ["Review Status"] = "검토 상태",
        ["Risk Class"] = "위험 분류",
        ["Robot Cell Acceptance (Stage 3 Boundary)"] = "로봇 셀 승인 (3단계 경계)",
        ["Robot acceptance"] = "로봇 승인",
        ["Robot controls default to Not Connected. Simulated evidence never claims real hardware readiness or safety certification."] = "로봇 제어는 기본적으로 연결 안 됨 상태입니다. 시뮬레이션 증빙은 실제 하드웨어 준비성이나 안전 인증을 절대 주장하지 않습니다.",
        ["Robot/PLC controls default to Not Connected. Real Hardware is not connected from this screen. Simulated evidence never claims real hardware readiness or safety certification."] = "로봇/PLC 제어는 기본적으로 연결 안 됨 상태입니다. 이 화면에서는 실제 하드웨어가 연결되지 않습니다. 시뮬레이션 증빙은 실제 하드웨어 준비성이나 안전 인증을 절대 주장하지 않습니다.",
        ["Role"] = "역할",
        ["Run 3D Acceptance Test"] = "3D 승인 테스트 실행",
        ["Run Camera Acceptance Test"] = "카메라 승인 테스트 실행",
        ["Run Lighting Sync Test"] = "조명 동기화 테스트 실행",
        ["Run Model Acceptance"] = "모델 승인 실행",
        ["Run Robot Cell Acceptance"] = "로봇 셀 승인 실행",
        ["Run Traceability Test"] = "추적성 테스트 실행",
        ["Run UI Stability Test"] = "UI 안정성 테스트 실행",
        ["Run the Stage 1 validation workflow."] = "1단계 검증 워크플로를 실행하십시오.",
        ["Runtime status"] = "런타임 상태",
        ["SIM / MOCK ACTIVE"] = "시뮬레이션 / 모의 활성",
        ["SPC / SQLite Summary"] = "SPC / SQLite 요약",
        ["SQLite Logs"] = "SQLite 로그",
        ["SQLite Records"] = "SQLite 기록",
        ["SQLite Yield"] = "SQLite 수율",
        ["SQLite summary loaded from local PoC database."] = "로컬 PoC 데이터베이스에서 SQLite 요약을 불러왔습니다.",
        ["Sample CSV"] = "샘플 CSV",
        ["Sample Data Mode. 3D Camera Not Connected. Stage 2 hardware integration required for live 3D profile inspection."] = "샘플 데이터 모드입니다. 3D 카메라가 연결되어 있지 않습니다. 실시간 3D 프로파일 검사에는 2단계 하드웨어 통합이 필요합니다.",
        ["Sample Image"] = "샘플 이미지",
        ["Save Profile"] = "프로파일 저장",
        ["Saved Profile"] = "저장된 프로파일",
        ["Saved Profile Details"] = "저장된 프로파일 상세",
        ["Saved version"] = "저장된 버전",
        ["Selected Defect Details"] = "선택한 결함 상세",
        ["Selected Engine"] = "선택된 엔진",
        ["Send Result to Traceability System"] = "결과를 추적성 시스템으로 전송",
        ["Sent"] = "전송됨",
        ["Serial / Baud"] = "시리얼 / 보레이트",
        ["Serial Text Protocol (Real Hardware)"] = "시리얼 텍스트 프로토콜 (실제 하드웨어)",
        ["Set Active"] = "활성으로 설정",
        ["Set PW"] = "비밀번호 설정",
        ["Set as Active Inspection Model"] = "활성 검사 모델로 설정",
        ["Settings are staged by category. Apply writes changes through the existing services; Cancel reloads the last saved values."] = "설정은 카테고리별로 임시 보관됩니다. 적용은 기존 서비스를 통해 변경 사항을 저장하고, 취소는 마지막 저장 값을 다시 불러옵니다.",
        ["Shift"] = "교대조",
        ["Show Difference"] = "차이 표시",
        ["Side Device ID"] = "측면 장치 ID",
        ["Simulated mode is not real hardware. TCP/serial commands are sent only when explicitly configured."] = "시뮬레이션 모드는 실제 하드웨어가 아닙니다. TCP/시리얼 명령은 명시적으로 구성된 경우에만 전송됩니다.",
        ["Simulation is not production robot validation"] = "시뮬레이션은 운영 로봇 검증이 아님",
        ["Soak Test"] = "소크 테스트",
        ["Software Trigger"] = "소프트웨어 트리거",
        ["Source status"] = "소스 상태",
        ["Stage 1 Customer Data Validation"] = "1단계 고객 데이터 검증",
        ["Stage 1 Image"] = "1단계 이미지",
        ["Stage 1 PASS is scoped to local image-validation evidence. Real camera, lighting, robot, PLC safety, production MES, ERP, and full factory automation remain not validated unless their own evidence exists."] = "1단계 PASS는 로컬 이미지 검증 증빙으로 범위가 제한됩니다. 실제 카메라, 조명, 로봇, PLC 안전, 운영 MES, ERP 및 전체 공장 자동화는 자체 증빙이 존재하지 않는 한 미검증 상태로 유지됩니다.",
        ["Stage 1 Readiness"] = "1단계 준비도",
        ["Stage 1 image-validation evidence is for review. Camera, lighting, robot, safety, and MES readiness still require Hardware Readiness evidence before any real factory-integration claim."] = "1단계 이미지 검증 증빙은 검토용입니다. 카메라, 조명, 로봇, 안전, MES 준비성은 실제 공장 통합을 주장하기 전에 하드웨어 준비성 증빙이 여전히 필요합니다.",
        ["Stage 1 readiness not evaluated."] = "1단계 준비도가 평가되지 않았습니다.",
        ["Stage 2 Camera Pilot"] = "2단계 카메라 파일럿",
        ["Stage 2 preparation only - not live camera/robot calibration"] = "2단계 준비 전용 - 실제 카메라/로봇 보정 아님",
        ["Stage 2+"] = "2단계 이상",
        ["Stage 3 Robot Cell Pilot"] = "3단계 로봇 셀 파일럿",
        ["Stage 4 MES Traceability Pilot"] = "4단계 MES 추적성 파일럿",
        ["Standards traceability not loaded."] = "표준 추적성이 로드되지 않았습니다.",
        ["Start New Pilot"] = "새 파일럿 시작",
        ["Static Schema Reference"] = "정적 스키마 참조",
        ["Station "] = "스테이션 ",
        ["Station / Interval"] = "스테이션 / 주기",
        ["Status "] = "상태 ",
        ["Status summary loading..."] = "상태 요약 불러오는 중...",
        ["Storage Path"] = "저장 경로",
        ["Storage, operating mode, and deployment profile affect readiness gates and audit records."] = "저장소, 운전 모드, 배포 프로파일은 준비도 게이트와 감사 기록에 영향을 줍니다.",
        ["Sync Pan"] = "이동 동기화",
        ["Sync Zoom"] = "확대/축소 동기화",
        ["Sync acceptance"] = "동기화 승인",
        ["TCP Host / Port"] = "TCP 호스트 / 포트",
        ["TCP Text Protocol (Real Hardware)"] = "TCP 텍스트 프로토콜 (실제 하드웨어)",
        ["Test / Send Payload"] = "테스트 / 페이로드 전송",
        ["Test Camera Source"] = "카메라 소스 테스트",
        ["Test Lighting"] = "조명 테스트",
        ["The page failed to refresh."] = "페이지를 새로 고치지 못했습니다.",
        ["These actions create diagnostics, backups, restore previews, or support bundles. Package outputs redact secrets by default."] = "이 동작은 진단, 백업, 복원 미리보기 또는 지원 번들을 생성합니다. 패키지 출력은 기본적으로 시크릿을 숨김 처리합니다.",
        ["Threshold Profiles"] = "임계값 프로파일",
        ["Timeout ms"] = "타임아웃 ms",
        ["Timeouts ms"] = "타임아웃 ms",
        ["Tolerance Map"] = "공차 맵",
        ["Top Device ID"] = "상면 장치 ID",
        ["Top-Down 2D Map"] = "상면 2D 맵",
        ["Training Set Export (Local Files)"] = "학습 세트 내보내기 (로컬 파일)",
        ["Transform Status"] = "변환 상태",
        ["UI stability not run. Use 30-minute or better PASS evidence before client demo export."] = "UI 안정성 테스트가 실행되지 않았습니다. 고객 데모 내보내기 전에 30분 이상 PASS 증빙을 사용하십시오.",
        ["User"] = "사용자",
        ["User Role"] = "사용자 역할",
        ["Validate"] = "검증",
        ["Validate List"] = "목록 검증",
        ["Validation Package"] = "검증 패키지",
        ["Vault"] = "보관소",
        ["Verify Paths"] = "경로 검증",
        ["Verify Selected Export"] = "선택 항목 내보내기 검증",
        ["Version Comparison"] = "버전 비교",
        ["View Acceptance Runs"] = "승인 실행 기록 보기",
        ["Visible GUI"] = "표시되는 GUI",
        ["Visual Training Output"] = "시각 학습 출력",
        ["Volume"] = "체적",
        ["Waive Selected"] = "선택 항목 면제",
        ["Waived"] = "면제됨",
        ["Warn on the Export & Trace screen before purge"] = "영구 삭제 전 내보내기 / 추적 화면에서 경고",
        ["Yield"] = "수율",
        ["local"] = "로컬",
        ["local review console / prototype"] = "로컬 검토 콘솔 / 프로토타입",
        ["low to high"] = "낮음 → 높음",
        ["none"] = "없음",
        ...
        ["BOUNDARY ONLY"] = "경계 전용",
        ["NO SOURCE"] = "소스 없음",
        ["Select a feature or map point to plot its height slice."] = "특징 또는 맵 지점을 선택하면 높이 단면이 표시됩니다.",
        ["Operate"] = "운영",
    ...
    private static void ApplyWindowPreferences(UiPreferences current, CultureInfo culture, bool resizeWindowToPreset)
    {
        ...
        // Retarget the shared family token too: styled controls resolve
        // HmiFontFamily dynamically, so Korean mode gets Malgun-first rendering
        // everywhere, not only on inherited (style-less) text.
        var languageFamily = current.Language == UiLanguage.Korean
            ? new FontFamily("Malgun Gothic, Segoe UI")
            : new FontFamily("Segoe UI, Malgun Gothic");
        mainWindow.FontFamily = languageFamily;
        Application.Current.Resources["HmiFontFamily"] = languageFamily;
